...
<script type="text/javascript" language="javascript">
	$(document).ready(function()
	{
		$("#generate_report").click(function()
		{
			...
			{
				window.location = window.location+'/'+$("#report_date_range_simple option:selected").val() + '/'+sale_type+'/'+ employee_type + '/' + export_excel;
			}
			else
			{
				...
				window.location = window.location+'/'+start_date + '/'+ end_date + '/'+sale_type+'/'+ employee_type + '/' + export_excel;
			}
		});  
