...
<head>
    ...
    <title><?php 
		 ...
		 echo !is_on_demo_host() ?  $this->config->item('company').' -- '.lang('common_powered_by').' NetstartPOS' : 'Demo - F | Easy to use Online POS Software' ?></title>
