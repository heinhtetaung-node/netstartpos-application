...
<div class="row add-location-link">
	<div class="col-md-12 text-center">
		<?php if (!is_on_demo_host()) { ?>
			<strong><a href="http://apps.amztechnology.com/netstartposv2/buy_additional.php" target="_blank"><?php echo lang('locations_adding_location_requires_addtional_license'); ?></a></strong>
		<?php } ?>
	</div>
</div>
