			...
			<div class="panel">
				<div class="panel-body">
					...
					<div id="mercury_activate_container">
						<h3><a href="http://apps.amztechnology.com/netstartposv2/credit_card_processing.php" target="_blank"><?php echo lang('common_credit_card_processing'); ?></a></h3>
						<a href="http://apps.amztechnology.com/netstartposv2/credit_card_processing.php" class="mercury_description" target="_blank">
		...
		<?php if(isset($month_sale) && !isset($month_sale['message'])){ ?>
			var data = {
				...
				datasets: [
				{
					fillColor : "#EDC9ED",
					strokeColor : "#EDC9ED",
					highlightFill : "#EDC9ED",
					highlightStroke : "#EDC9ED",
