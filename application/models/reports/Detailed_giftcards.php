...
class Detailed_giftcards extends Report
{
	...
	public function getData()
	{
		...
		{
			$this->db->like('payment_type', lang('common_giftcard').':'.$this->params['giftcard_number']);
		}
